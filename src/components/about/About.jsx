import aboutImage01 from "../../assets/images/about/about-image-01.jpg";

import aboutImage02 from "../../assets/images/about/about-image-02.jpg";
import ExperienceLeftSvg from "../../assets/svg/about/ExperienceLeftSvg";
import ExperienceRightBottomSvg from "../../assets/svg/about/ExperienceRightBottomSvg";
import ExperienceRightTopSvg from "../../assets/svg/about/ExperienceRightTopSvg";
                  ...
                  <div className="relative z-10 mb-4 flex items-center justify-center overflow-hidden bg-primary px-6 py-12 sm:mb-8 sm:h-[160px] sm:p-5 lg:mb-4 xl:mb-8">
                    ...
                    <div>
                      ...
                      <span className="absolute right-0 top-0 -z-10">
                        <ExperienceRightTopSvg />
                      </span>
                      <span className="absolute bottom-0 right-0 -z-10">
                        <ExperienceRightBottomSvg />
                      </span>
                    </div>
                  </div>
                </div>
